...
public class PendudukController {
	...
	public String addPendudukSubmit(Model model, @RequestParam(value = "nama", required = true) String nama,
		...
		// cek apa ada yang lahir di kelurahan & tanggal lahir yang sama untuk
		// tentuin 4 digit terakhir (urutan)
		...
		PendudukModel penduduk = new PendudukModel(id, nik, nama, tempatLahir, tglLahir, jenisKelamin, isWni,
				keluarga.getId(), agama, pekerjaan, statusPerkawinan, statusDalamKeluarga, golonganDarah, isWafat, null,
	...
	public String searchPenduduk(Model model, @RequestParam(value = "kt", required = false) Integer kt,
